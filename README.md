...
2. 网络通信：基于Photon Fusion 2构建实时多人联机框架，采用**Host/Client模式**结合**状态同步**机制，实现角色移动、物理交互与布娃娃系统的跨端一致性。利用Fusion的**客户端预测**+**回滚**机制保证输入响应与状态一致性。通过Networked状态变量与NetworkRigidbody3D实现关键状态同步。
